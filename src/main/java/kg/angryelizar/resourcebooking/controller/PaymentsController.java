...
@Tag(name = "Управление платежами", description = "Просмотр методов оплаты для всех пользователей, а также просмотр, редактирование и удаление платежей для администраторов")
public class PaymentsController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Запрос прошел успешно", content = @Content(schema = @Schema(implementation = PaymentReadDTO.class))),
